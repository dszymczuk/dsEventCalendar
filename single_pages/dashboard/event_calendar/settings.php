...
<div class="row">
	<div class="span5">
		...
		<form class="form-horizontal" method="post" id="ccm-multilingual-page-report-form" style="margin-top: 15px;">
            ...
            <fieldset class="control-group">
                <label class="control-label"><?php echo t('Scroll on input to change date / time') ?></label>
                <div class="controls">
                    <input
                        type="checkbox"
                        name="scrollInput"
                        id="scrollInput"
                        value="<?php echo $scrollInput; ?>"
